...
"""
Creates an rfile from the USGS CVM (Stephenson et al., 2017). 
This script converts the binary files that contain the model into an rfile format.
...
Script structure:
    ...
    3) Running rfile building functions:
        ...
        - Writing rfile blocks.
            ...
            2. Creating k-array for each grid point from the connected block layers and writing to rfile.
...
## output settings
outpath = '/Users/rshimony/Desktop/WillametteValley/wv_project/rfiles/usgs_cvm/'
os.chdir(outpath)
