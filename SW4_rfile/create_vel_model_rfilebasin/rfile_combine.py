...
hhi = (100,100)
hvi = (100,100)
block_layers = (0,11000) ##block_layers = (-4000, 30000, 70000, 100000, 200000)

plot_resampled_3D = 1

outpath = '/Users/rshimony/Desktop/WillametteValley/Models/rfile_combine/'
...
rfileoutput = 'rfile_1layer_ifile_grav.rfile'

# Creating an array for the velocity model
ifile_in = 'cal_depth_ifile_grav_dip_4rfile.txt'
n_tif = 2
dx = 100 #(m)
dy = -100 #(m)
...
[1,  2.218e3, 0.8e3, 1.996e3, 110.7,  55.35],
[2,  4.64e3, 2.75e3, 2.48e3, 501,  250.5]])
...
#%%
# ---------------------------------------------------------------------------
cs = model.get_cross_section(0, 350, 380, 380)
...
z, properties = model.get_z_profile(2, 2)
...
#%%
z, properties = model.get_z_profile(120, 180)
...
lat_bin = np.linspace(0.0, 100, 21)
lon_bin = np.linspace(0.0, 100, 21)
