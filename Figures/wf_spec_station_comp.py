...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan  5 20:30:45 2024
...
working_dir = '/Users/rshimony/Desktop/WillametteValley/final_outputs/figs/wf_spec_station_comp_horiz/springfield/srv_sm/'
model = 'srv_sm'
...
for i in range(len(obs_strs_3)):
    ...
    plt.xlim([-5,80])
    plt.title(trobs.stats.channel[-1] ,size=15)
