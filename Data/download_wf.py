...
st_dom_df.to_csv('/Users/rshimony/Desktop/WillametteValley/salem_eq/metadata/salem_domain_stations.csv',index=False)
...
#%%
# Create FF of stations in and close to the valley

stations_dom_old = pd.read_csv('/Users/rshimony/Desktop/WillametteValley/springfield_eq/metadata/snr_stations_fixed.csv')
st_lat_dom_old = stations_dom_old['st_lat']
st_lon_dom_old = stations_dom_old['st_lon']
st_name_dom_old = stations_dom_old['st_nm']
...
for i in range(len(st_lat_dom_old)):
    grd_point = Point(st_lon_dom_old[i],st_lat_dom_old[i])
    if buffered_fullpoly.contains(grd_point) == True:
        
        dom_valst_lons.append(st_lon_dom_old[i])
        dom_valst_lats.append(st_lat_dom_old[i])
        dom_valst_names.append(st_name_dom_old[i])
        

dom_valstdict = {'dom_valst_names':dom_valst_names, 'dom_valst_lons':dom_valst_lons, 'dom_valst_lats':dom_valst_lats}
...
plt.scatter(st_lons,st_lats, c='b')
plt.scatter(valst_lons,valst_lats, c='g')
plt.scatter(dom_valst_lons,dom_valst_lats, c='gold')
plt.show()
