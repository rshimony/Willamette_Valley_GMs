...
outpath = '/Users/rshimony/Documents/My_Notebooks/create_vel_model_rfilebasin'
os.chdir(outpath)

rfileoutput = 'stephenson_rfile_notopo_cartesian_srv.rfile'
...
ifile_in = '/Users/rshimony/Desktop/WillametteValley/Models/cartesian_ifile/ifile_cartesian_4rfile_cal_srv.txt' #'ALL_japan_path20111110.dat'
n_tif = 2
dx = 100 #(m)
dy = -100 #(m)
        ...
        for i in range(ni_blk):
            for j in range(nj_blk):
                ...
                #     lon_in.append(vp_blk.utme.values[j])
                    ...
                    # Determing k_array at location index [i,j]
                    k_array_basin = create_k_array(i,j,hhi_blk,n_tif,z_blk,vel_model)
